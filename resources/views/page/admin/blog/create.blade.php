...
@section('section')
    <form  style="width: 600px;margin: auto" method="POST" action="{{ route('admin.blog.store') }}" enctype="multipart/form-data">
        @csrf
    <div
    ...
    />
        ...
        <div
            class="px-[5px] mb-5 text-[rgb(73,80,87)] text-[14px]   grid col-span-full "
        >
            <label class="mb-2 text-center ">users</label>

            <select name="users[]" required multiple>
